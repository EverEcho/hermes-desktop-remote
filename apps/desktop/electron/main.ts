...
const APP_NAME = process.env.HERMES_DESKTOP_APP_NAME || 'RHermes'
...
if (IS_WINDOWS) {
  app.setAppUserModelId('cn.13bit.rhermes')
}
...
app.setAboutPanelOptions({
  ...
  copyright: 'Copyright © 2026 13bit'
})
