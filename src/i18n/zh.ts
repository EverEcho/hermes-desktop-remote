...
export const zh: Catalog = {
  ...
  sidebar: {
    ...
    home: '主页',
    recent: '最近',
    scheduledRuns: '定时任务会话',
    messageSessions: '消息会话',
    pin: '置顶对话',
    unpin: '取消置顶',
    markUnread: '标记为未读',
    markRead: '标记为已读',
  ...
  composer: {
    ...
    steer: '引导当前任务',
    queue: '加入下一轮队列',
    queued: (count: number) => `已排队 ${count} 条`,
    removeQueued: '移除排队消息',
    sendNext: '发送下一条',
  ...
  approvals: {
    ...
    mcpSetupTitle: '请求配置 MCP',
    mcpSetupDescription: '代理希望配置此 MCP 服务。',
    mcpSetupAllow: '允许配置',
    mcpSetupAuthFailed: 'MCP 授权未完成。'
  },
  settings: {
    title: '设置',
    gateway: '网关',
    ...
    modelPage: {
      ...
      setupHintOAuth: (name: string) => `${name} 需要通过服务商登录流程完成授权。`,
      efforts: {
        none: '关闭',
        minimal: '最小',
        low: '低',
    ...
    billing: {
      desc: '套餐、用量与额度请在 Nous Portal 中管理。',
  ...
  skills: {
    ...
    view: '查看',
    toolsets: '工具集',
    toolsetsDescription: '智能体可用的网关工具集。',
    needsSetup: '需要配置',
    noToolsets: '网关未报告任何工具集。',
    mcpServers: 'MCP 服务',
    mcpServersDescription: '已配置的模型上下文协议 (MCP) 服务。',
    manage: '管理',
    toolsCount: (n: number) => `${n} 个工具`,
    noMcpServers: '未配置 MCP 服务。',
    configure: '配置',
    previewError: '无法从网关加载该技能内容。'
  },
  cron: {
    title: '定时任务',
    ...
    emptyDescNew: '按 cron 表达式排程一个提示词，或选择左侧自动化模板快速创建。',
    ...
    delivery: '投递到',
    deliveryNone: '不自动投递',
    deliveryUnavailable: '暂无可用投递目标',
    deliveryNotConfigured: '未配置',
    prompt: '提示词',
    ...
    customHint: '标准 5 位 Cron 表达式（分 时 日 月 周）。',
    optional: '可选',
    startFromLabel: '起始模板',
    customTemplate: '自定义（空白任务）',
    saveChanges: '保存更改',
    createAction: '创建定时任务',
    blueprints: {
      tab: '自动化模板',
  ...
  artifacts: {
    title: '产物',
    filterPlaceholder: '搜索产物…',
    refresh: '刷新',
    description: '汇总网关最近 30 个会话中生成的文件与链接。',
    indexing: '正在索引会话历史…',
    empty: '未找到生成的文件或链接。',
    preview: '预览',
    open: '打开',
